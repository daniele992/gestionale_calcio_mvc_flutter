...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    displaySmall: GoogleFonts.poppins(
        fontSize: 24.0, fontWeight: FontWeight.normal, color: tDarkColor),
    headlineMedium: GoogleFonts.poppins(
        fontSize: 18.0, fontWeight: FontWeight.w600, color: tDarkColor),
    headlineSmall: GoogleFonts.poppins(
        fontSize: 18.0, fontWeight: FontWeight.normal, color: tDarkColor),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    displaySmall: GoogleFonts.poppins(
        fontSize: 24.0, fontWeight: FontWeight.normal, color: tWhiteColor),
    headlineMedium: GoogleFonts.poppins(
        fontSize: 18.0, fontWeight: FontWeight.w600, color: tWhiteColor),
    headlineSmall: GoogleFonts.poppins(
        fontSize: 18.0, fontWeight: FontWeight.normal, color: tWhiteColor),
    titleLarge: GoogleFonts.poppins(
    ...
    bodyMedium: GoogleFonts.poppins(
        fontSize: 14.0, color: tWhiteColor.withOpacity(0.8)),
  );
} //Closed TTextTheme
